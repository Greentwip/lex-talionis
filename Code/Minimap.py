...
class MiniMap(object):
    ...
    def draw(self, surf, camera_offset, progress=1):
        ...
        viewport_height = GC.WINHEIGHT//self.scale_factor - 2  # In tiles should be 38
        ...
        topleftpos = (max(4, GC.WINWIDTH//2 - image.get_width()//2), max(4, GC.WINHEIGHT//2 - image.get_height()//2))
